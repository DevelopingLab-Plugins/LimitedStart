...
$checkch = file_get_contents("https://api.telegram.org/bot".$bottoken."/getChatMember?chat_id=$usernamecanale&user_id=$userID"); //Identifica chi è nel canale e chi no, al posto di $userID dovrete mettere la variabile che trova l' ID di un utente del vostro framkework;
